...
from code.Const import COLOR_YELLOW, COLOR_GREEN, SCORE_POS, MENU_OPTION, COLOR_WHITE, COLOR_ORANGE
...
class Score:
    ...
    def save(self, game_mode: str,player_score: list[int]):
        ...
        while True:
            ...
            self.score_text(20, text, COLOR_ORANGE, SCORE_POS['EnterName'])
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == K_RETURN and len(name) == 4:
                        ...
                        if len(name) < 4:
                            name += event.unicode
            self.score_text(20, name, COLOR_ORANGE, SCORE_POS['Name'])
            pygame.display.flip()
